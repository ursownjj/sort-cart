...
onSelectingSortingAlgorithm(eventKey,event)
{
  let timeComplexity = {
    ...
    {
    case 'Quick Sort':
    timeComplexity.best = `O(n log n)`
    timeComplexity.average = `O(n log n)`
    timeComplexity.worst = `O(n^2)`
    break;
...
<Dropdown.Item eventKey='Quick Sort'>Quick Sort(Default)</Dropdown.Item>
...
<Row>
<Col>
<Alert><br></br>Time Complexity: Best Case - {this.state.timeComplexity.best}, Average Case - {this.state.timeComplexity.average}, Worst Case - {this.state.timeComplexity.worst}</Alert>
</Col>
</Row>
<Row>
<Col>
